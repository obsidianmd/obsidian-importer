...
export const en = {
	...
	source: {
		...
		msgAndroidFolderFailed: 'Could not choose that folder.',
		msgAndroidFolderReadFailed: 'Could not read that folder.',
		msgAndroidFolderUnavailable: 'Folder selection is unavailable on this device.',
		msgAndroidRootFolder: 'Choose a folder other than the root of your device.',
	...
	template: {
		...
		descTemplateFile: 'Optional. Choose a template from your vault to format the note content. See Help for {{link}}.',
		linkTemplateSyntax: 'template syntax',
	...
	importer: {
		...
		logseq: {
			...
			descInstructions: 'Read the instructions for importing from Logseq.',
			...
			nameFlashcards: 'Keep flashcards',
			descFlashcards: 'Obsidian doesn\'t support Logseq\'s flashcards, so card markers and cloze wrappers are imported as plain text.',
			nameTimeTracking: 'Keep time tracking',
			descTimeTracking: 'Obsidian doesn\'t support Logseq\'s time tracking, so LOGBOOK and CLOCK entries are imported as plain text.',
