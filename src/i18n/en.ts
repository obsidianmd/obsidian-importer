...
export const en = {
	...
	importer: {
		airtableApi: {
			...
			nameConnect: 'Connect to Airtable',
		...
		appleNotes: {
			...
			nameAccess: 'Allow access to your notes',
		...
		onenote: {
			...
			nameConnect: 'Connect to OneNote',
			descConnect: 'Sign in with the Microsoft account your notebooks are in, then pick the sections to import.',
