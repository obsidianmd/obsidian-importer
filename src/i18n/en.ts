...
export const en = {
	...
	importer: {
		...
		markdown: {
			...
			fileType: 'Markdown',
			descSource: 'Choose individual Markdown files, whole folders, or zip files. Everything inside a folder or zip file stays organized the same way.',
			nameFolders: 'Folders to import',
			descFolders: 'Everything inside a folder comes with it. Untick one to leave it out.',
			msgPickSourceFirst: 'Choose files or folders first.',
			msgReadingFolders: 'Reading folders...',
			msgNoFolders: 'No folders found.',
			nameStandardizeFormatting: 'Standardize formatting',
			descStandardizeFormatting: 'Use this vault\'s settings for lists, indentation, and links. Turn this off to preserve the source formatting.',
