...
export const en = {
	...
	importer: {
		...
		roamJson: {
			...
			headingBlockReferences: 'Block references',
			...
			descDropUnresolvedReferences: 'A reference to a block that is not in the export is kept as it was written. If enabled, it is removed instead.',
			headingRoamMarkup: 'Roam markup',
			...
			descDropQueries: 'A query becomes an Obsidian search that shows its results in the note. If enabled, queries are removed instead.',
