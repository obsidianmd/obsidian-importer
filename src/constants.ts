...
/**
 * Where an importer records the id its source gave a note, so a later import
 * recognises it after a rename. Shared where two importers read the same
 * source: a Notion workspace can arrive as a zip or over the API.
 */
